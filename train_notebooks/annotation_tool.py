...
class LabelerWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # image name label
        self.img_name_label.setGeometry(20, 40, self.img_panel_width, 40)
        ...
        # image name
        self.img_name_label.setText(self.img_paths[self.counter].split("/")[-1])
    ...
    def show_next_image(self):
        ...
        if self.counter < self.num_images - 1:
            ...
            self.set_image(path)
            self.img_name_label.setText(path.split("/")[-1])
